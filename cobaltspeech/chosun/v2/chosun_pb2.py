...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DOMAININFO_DOMAINSENTRY._serialized_options = b'8\001'
  _PARSEREQUEST_CONTEXTFEATURESENTRY._options = None
  _PARSEREQUEST_CONTEXTFEATURESENTRY._serialized_options = b'8\001'

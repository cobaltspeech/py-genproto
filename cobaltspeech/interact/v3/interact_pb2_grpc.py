...
def add_InteractServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Version': grpc.unary_unary_rpc_method_handler(
                    servicer.Version,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.VersionRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.VersionResponse.SerializeToString,
            ),
            'ListModels': grpc.unary_unary_rpc_method_handler(
                    servicer.ListModels,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.ListModelsRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.ListModelsResponse.SerializeToString,
            ),
            'CreateSession': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateSession,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.CreateSessionRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.CreateSessionResponse.SerializeToString,
            ),
            'DeleteSession': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteSession,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.DeleteSessionRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.DeleteSessionResponse.SerializeToString,
            ),
            'UpdateSession': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateSession,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.UpdateSessionRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.UpdateSessionResponse.SerializeToString,
            ),
            'StreamASR': grpc.stream_unary_rpc_method_handler(
                    servicer.StreamASR,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.StreamASRRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.StreamASRResponse.SerializeToString,
            ),
            'StreamASRWithPartials': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamASRWithPartials,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.StreamASRWithPartialsRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.StreamASRWithPartialsResponse.SerializeToString,
            ),
            'Transcribe': grpc.stream_stream_rpc_method_handler(
                    servicer.Transcribe,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.TranscribeRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.TranscribeResponse.SerializeToString,
            ),
            'StreamTTS': grpc.unary_stream_rpc_method_handler(
                    servicer.StreamTTS,
                    request_deserializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.StreamTTSRequest.FromString,
                    response_serializer=cobaltspeech_dot_interact_dot_v3_dot_interact__pb2.StreamTTSResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cobaltspeech.interact.v3.InteractService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cobaltspeech.interact.v3.InteractService', rpc_method_handlers)
